    ...
    public partial class Form1 : Form
    {
        ...
        private void panel1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if(square)
            {
                ...
                g.FillRectangle(sb, e.X, e.Y, Convert.ToInt32(toolStripTextBox2.Text),
            ...
            {
                SolidBrush sb = new SolidBrush(toolStripButton1.ForeColor);
                g.FillRectangle(sb, e.X, e.Y, Convert.ToInt32(toolStripTextBox2.Text) * 2, 
                                              Convert.ToInt32(toolStripTextBox2.Text));
                regrangle = false;
                canPaint = false;
            }
            ...
            {
                SolidBrush sb = new SolidBrush(toolStripButton1.ForeColor);
                g.FillEllipse(sb, e.X, e.Y, Convert.ToInt32(toolStripTextBox2.Text), Convert.ToInt32(toolStripTextBox2.Text));
                circle = false;
                canPaint = false;
            }
        }
